...
public class Player extends Sprite implements Disposable {
    ...
    private float stepInterval = 0.8f;
    private Sound sound = ManagerAudio.getSound("player/audio/WALK.wav");
        ...
        private TextureRegion getFrame(float delta) {
            ...
            switch (currentState) {
                ...
                case attack:
                if (attackcont==0) {
                    Sound sound = ManagerAudio.getSound("player/audio/ATTACK_1.wav");
                ...
                case death:
                    if (deathcont==0) {
                    Sound deathSound = ManagerAudio.getSound("player/audio/DEATH.wav");
    ...
    public void pickupHeart() {
        game.playSound(ManagerAudio.getSound("pick/pickitem.wav"));
        if (currentHealth < maxHealth) {
            currentHealth += 10;
        }
    }
